...
export default function Solve() {
  ...
  async function handleClick() {
    ...
    try {
      ...
      const prompt = `This is my question ${input}.Give me a solution in ${selectedLanguage}`;
    ...
    <>
      <div className="flex flex-col  bg-[#191A1E] min-h-screen  w-full overflow-x-hidden">
        <div className="mt-7 flex flex-row justify-center items-center  break-words">
          ...
          >
            Type Your Doubt...Let's Solve it
          </AuroraText>
        </div>
          ...
          >
            <ResizablePanel defaultSize={50} minSize={20}>
              <div className="flex flex-col h-full  ">
                <textarea
                  className="resize-none w-full h-full p-5  bg-[#24262C] text-white"
